 ...
 * <p>
 * Handles HTTP requests and delegates business logic to
 * {@link DataAnalysisService}.
...
public class DataAnalysisController {
     ...
     * <p>
     * Validates the input data (rejects data containing "Sonny Hayes"), performs
     * analysis,
     * persists the results to the database, and returns statistics about the CSV.
     *
     * @param data the raw CSV data as a string
     * @return analysis results including row count, column count, total characters,
     ...
     * previously persisted to the database via the POST /api/analysis/ingestCsv
     * endpoint.
     *
     * @param id the ID of the analysis to retrieve
     * @return analysis results including row count, column count, total characters,
     *         and column statistics
     * @throws com.matillion.techtest2025.exception.NotFoundException if no analysis
     *                                                                exists with
     *                                                                the given ID
     *                                                                (returns HTTP
     *                                                                404)
    ...
    public DataAnalysisResponse getAnalysisById(@PathVariable Long id) {
        // -----------------------------------------------------------------
        // Part 2 implementation: delegate to service to fetch and map DTO
        // -----------------------------------------------------------------
